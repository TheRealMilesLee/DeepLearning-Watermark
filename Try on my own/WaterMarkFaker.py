...
parser.add_argument("--batch_size", type=int, default=1, help="number of images in batch") # If the GPU you using is Suck (i.e. GTX1050), set this to 1, otherwise it would not run
