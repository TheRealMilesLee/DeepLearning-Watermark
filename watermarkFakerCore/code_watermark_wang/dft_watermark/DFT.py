...
# 水印图片的地址，并将其读取
watermark_path = "D:/CS-Related/Watermark Faker/TestFolder/Test_Images/DFT/Train images/Watermark/lena_color_256.png"
...
input_path = "D:/CS-Related/Watermark Faker/TestFolder/Test_Images/DFT/Train images/Source"
output_path = "D:/CS-Related/Watermark Faker/TestFolder/Test_Images/DFT/Train images/Output"

if not os.path.exists(output_path):
  os.mkdir(output_path)

inputs = glob.glob(os.path.join(input_path, "*.bmp"))
