...
parser.add_argument("--output_dir", required=False, default=r"E:\freWatermark_experiment\experiment1\train_result", help="where to put output files")
parser.add_argument("--seed", type=int)
parser.add_argument("--checkpoint", default=r"E:\freWatermark_experiment\experiment1\train_result", help="directory with checkpoint to resume training from or use for testing")
