...
parser.add_argument("--output_dir", required=False, default=r"E:\freWatermark_experiment\experiment1\test_result(2020.4.17_0.008212)",
                    help="where to put output files")
parser.add_argument("--seed", type=int)
parser.add_argument("--checkpoint", default=r"E:\freWatermark_experiment\experiment1\train_result(2020.4.17_0.008212)",
