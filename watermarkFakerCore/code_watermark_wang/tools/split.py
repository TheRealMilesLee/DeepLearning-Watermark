...
parser.add_argument("--dir", type=str, required=False, default="/home/wangruowei/PycharmProjects/watermark2020/data/origin/others/train_split1", help="path to folder containing images")
