...
parser.add_argument("--input_dir", required=False,
                    default="/home/wangruowei/PycharmProjects/watermark2020/data/gray/test",
                    help="path to folder containing images")
parser.add_argument("--output_dir", required=False,
                    default="/home/wangruowei/PycharmProjects/watermark2020/data/pair_dft/test",
                    help="output path")
parser.add_argument("--operation", required=False, default="combine",
...
# combine
parser.add_argument("--b_dir", default="/home/wangruowei/PycharmProjects/watermark2020/data/watermark_dft", type=str,
...
def combine(src, src_path):
    ...
    for ext in [".png", ".jpg", ".bmp"]:
        sibling_path = os.path.join(a.b_dir, basename + "_wDFT" + ext)  # 这里是为了找到 A照片 对应的 B照片，而写的路径
...
def process(src_path, dst_path):
    ...
    if a.operation == "grayscale":
        ...
        dst = edges(src)
    elif a.operation == "rename":
        name, _ = os.path.splitext(os.path.basename(src_path))
        order = name.split("_")
        dst_path = os.path.join(a.output_dir, order[2] + ".png")
        dst = src
    else:
...
def main():
    ...
    for src_path in im.find(a.input_dir):
        ...
        # =================此处有修改=========================
        # dst_path = os.path.join(a.output_dir, str(count) + ".bmp")
        count = count + 1
        #
        dst_path = os.path.join(a.output_dir, name + ".png")  # 原本的语句
        # ==================================================
