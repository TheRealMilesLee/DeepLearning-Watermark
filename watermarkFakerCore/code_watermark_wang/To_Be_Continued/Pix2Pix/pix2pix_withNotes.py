...
parser.add_argument("--input_dir", default="D:/CS-Related/Watermark Faker/TestFolder/Test_Images/facades/test", help="path to folder containing images")
