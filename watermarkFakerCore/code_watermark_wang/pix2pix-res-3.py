...
# ２０２０年０１月０４日１２：４７：２２，res3版本，是将shortcut + res这个操作调整到tanh之前而形成的
...
parser.add_argument("--output_dir", required=False, default="database/lsb2/train_result_res3", help="where to put output files")
parser.add_argument("--seed", type=int)
parser.add_argument("--checkpoint", default="database/lsb2/train_result_res3", help="directory with checkpoint to resume training from or use for testing")
...
def create_generator(generator_inputs, generator_outputs_channels):
    ...
    with tf.variable_scope("decoder_1"):
        ...
        output = output + generator_inputs  # ２０２０年０１月０４日１２：４９：４４，王爇沩修改
