...
parser.add_argument("--output_dir", required=False, default="/home/wangruowei/PycharmProjects/watermark2020/experment_results/dct/train_result", help="where to put output files")
...
parser.add_argument("--display_freq", type=int, default=4000, help="write current training images every display_freq steps")
