...
# 2019年12月24日11点14分，这个版本是尝试修改Loss而创建的，实际并不是用这个代码跑，因为最后会将修改部分的代码移植到另外的电脑上

parser = argparse.ArgumentParser()
parser.add_argument("--input_dir", default="E:/MyWork_aboutWatermark/database/lsb/pairs/test", help="path to folder containing images")
parser.add_argument("--mode", required=False, default="test", choices=["train", "test", "export"])
parser.add_argument("--output_dir", required=False, default="E:/MyWork_aboutWatermark/database/lsb/pairs/test_result", help="where to put output files")
parser.add_argument("--seed", type=int)
parser.add_argument("--checkpoint", default="E:/MyWork_aboutWatermark/database/lsb/pairs/train_result", help="directory with checkpoint to resume training from or use for testing")
