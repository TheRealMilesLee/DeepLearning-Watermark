...
parser.add_argument("--output_dir", required=False, default="database/lsb2/train_result_res2", help="where to put output files")
parser.add_argument("--seed", type=int)
parser.add_argument("--checkpoint", default="database/lsb2/train_result_res2", help="directory with checkpoint to resume training from or use for testing")
